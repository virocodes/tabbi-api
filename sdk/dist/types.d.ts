 ...
 */
export type SSEEventType = "session.starting" | "session.running" | "session.paused" | "session.idle" | "message.user" | "message.assistant" | "message.tool" | "message.complete" | "error";
/**
 ...
 */
export type SSEEventData = SessionStartingData | SessionRunningData | SessionIdleData | MessageUserData | MessageAssistantData | MessageToolData | MessageCompleteData | ErrorData;
...
export declare class TabbiError extends Error {
     ...
     */
    constructor(code: string, message: string, details?: Record<string, unknown> | undefined, status?: number | undefined);
}
/**
